...
class MyBoardTest {
    ...
    @Test
    void forestAreaMaintainsImmutability() {
    ...
    @Test
    void meadowAreaMaintainsImmutability() {
    ...
    @Test
    void riverAreaMaintainsImmutability() {
    ...
    @Test
    void riverSystemAreaMaintainsImmutability() {
    ...
    @Test
    void meadowAreasMaintainsImmutability() {
    ...
    @Test
    void riverSystemAreasMaintainsImmutability() {
    ...
    @Test
    void adjacentMeadowReturnHasNoOpenConnections() {
        // : all occupants of the complete meadow
